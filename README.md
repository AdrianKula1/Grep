...
The program has one obligatory parameter which is a string to find as well as four optional parameters: -t number_of_threads -d directory_to_search -r name_of_results_file -l name_od_log_file 
